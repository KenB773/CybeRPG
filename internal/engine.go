...
var Questions = []Question{
	...
	{Category: "Incident Response", Prompt: "What is the purpose of a jump box?", Answer: "Isolated management access"},
	...
	{Category: "Networking", Prompt: "What’s the purpose of a subnet mask?", Answer: "Divide network and host portions"},
	{Category: "Phishing", Prompt: "What is a telltale sign of a phishing email?", Answer: "Urgency or spoofed sender"},
	...
	{Category: "Linux", Prompt: "What log file shows kernel events?", Answer: "/var/log/kern.log"},
	...
	{Category: "Blue Team", Prompt: "What is a honeypot?", Answer: "Deceptive system to attract attackers"},
	{Category: "Blue Team", Prompt: "What does EDR stand for?", Answer: "Endpoint Detection and Response"},
	{Category: "Blue Team", Prompt: "What is lateral movement?", Answer: "Attacker moving between hosts"},
	...
	{Category: "General", Prompt: "What is social engineering?", Answer: "Manipulating people to gain access"},
...
{Category: "Digital Forensics", Prompt: "What is a volatile artifact?", Answer: "Short-lived evidence like RAM"},
...
{Category: "Reverse Engineering", Prompt: "What is the purpose of a disassembler?", Answer: "Convert machine code to assembly"},
...
{Category: "Threat Hunting", Prompt: "What is a common indicator of beaconing behavior?", Answer: "Regular outbound intervals"},
{Category: "Threat Hunting", Prompt: "Which log type is useful to detect brute force attempts?", Answer: "Authentication logs"},
{Category: "Threat Hunting", Prompt: "What kind of anomaly may indicate lateral movement?", Answer: "Unusual credential use"},
{Category: "Threat Hunting", Prompt: "What is Sysmon used for?", Answer: "Detailed Windows event logging"},
{Category: "Threat Hunting", Prompt: "What tool can capture and filter live traffic?", Answer: "Wireshark"},
{Category: "Cryptography", Prompt: "What is the purpose of a hash function?", Answer: "Ensure data integrity"},
...
{Category: "Blue Team", Prompt: "What is a SOC playbook?", Answer: "Guideline for incident handling"},
...
{Category: "General", Prompt: "What does MITRE stand for?", Answer: "MITRE isn't an acronym"},
{Category: "General", Prompt: "What does APT stand for?", Answer: "Advanced Persistent Threat"},
{Category: "General", Prompt: "What is the purpose of red teaming?", Answer: "Simulate real attacks"},
{Category: "General", Prompt: "What is zero trust?", Answer: "Never trust, always verify"},
